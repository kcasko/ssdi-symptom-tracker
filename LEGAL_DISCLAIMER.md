...
**ALWAYS CONSULT A QUALIFIED HEALTHCARE PROFESSIONAL** for medical advice, diagnosis, or treatment. Never disregard professional medical advice or delay seeking it because of information recorded in this app.
...
- Evidence Mode timestamps are **user-generated**, not legally certified
...
2. **Indirect Damages**: Lost benefits, legal fees, emotional distress
3. **Consequential Damages**: Any damages resulting from app use or inability to use
...
- **Finalization is a user action**: "Finalizing" logs does not create legal immutability
- **Revision tracking is for reference**: Revision history is a convenience feature, not a legal audit trail
...
- ❌ Not for use by healthcare clearinghouses
...
- This app is **not affiliated with** the SSA
- SSA regulations may change; the app may not reflect current requirements
...
By using this app, you agree to **indemnify and hold harmless** the developers, contributors, and distributors from any claims, damages, or expenses arising from:

- Your use or misuse of the app
- Your submission of app-generated documentation to SSA or legal proceedings
- Inaccurate information you entered into the app
- Reliance on app features, calculations, or reports
...
**Continued use** after changes constitutes acceptance of the updated disclaimer. Check the repository for the latest version.

---

## 12. Severability

If any provision of this disclaimer is found to be unenforceable or invalid, that provision shall be limited or eliminated to the minimum extent necessary, and the remaining provisions shall remain in full effect.

---

## 13. Entire Agreement

This disclaimer, together with the Privacy Policy and Terms of Service, constitutes the entire agreement regarding the use of this app.
...
✅ **Enable device encryption** for sensitive health data  
✅ **Back up your data** regularly  
...
By using this app, you acknowledge that you understand:

1. This is a **personal tracking tool**, not a medical or legal service
2. You are **solely responsible** for the accuracy of information entered
3. The developers have **no liability** for SSDI application outcomes
4. You should **consult professionals** for medical and legal advice
5. You **assume all risks** associated with using this app
6. You are responsible for **data backup and security**
...
⚠️ **Verify all exported documentation before submission**  
⚠️ **You are solely responsible for the truthfulness of recorded information**
